window.onload = function() {
    ...
    displayfusuButton.onclick = function() {
        ...
        // controlElement.appendChild(createButton('increaseButton', '放大', function() {
        //     var imageElement = newWindow.document.getElementById('myImage');
        //     scale += 10;
        //     imageElement.style.width = scale + '%';
        //     newWindow.document.getElementById('scaleInfo').innerText = '当前比例：' + scale + '%';
        // }));
        // controlElement.appendChild(createButton('decreaseButton', '缩小', function() {
        //     var imageElement = newWindow.document.getElementById('myImage');
        //     scale -= 10;
        //     imageElement.style.width = scale + '%';
        //     newWindow.document.getElementById('scaleInfo').innerText = '当前比例：' + scale + '%';
        // }));
        // controlElement.appendChild(createParagraph('scaleInfo', '当前比例：100%'));
        controlElement.appendChild(createButton('previousButton', '上一张', function() {
            currentIndex--;
            if (currentIndex < 0) { currentIndex = imageUrls.length - 1; }
            updateImageAndPageInfo();
        }));
        controlElement.appendChild(createButton('nextButton', '下一张', function() {
            currentIndex++;
        ...
        controlElement.appendChild(createButton('goButton', 'Go', function() {
            ...
            if (pageIndex >= 0 && pageIndex < imageUrls.length) {
                ...
                newWindow.document.getElementById('warning').innerText = '此页已经超出范围';
            }
        }));
   ...
   // 編集ボタン
    editButton.onclick = function() {
        ...
        var editUrl = 'edit2.html?image=' + encodeURIComponent(imageUrl);
